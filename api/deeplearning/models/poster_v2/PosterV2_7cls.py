...
class pyramid_trans_expr2(nn.Module):
    def __init__(self, img_size=224, num_classes=7, window_size=[28,14,7], num_heads=[2, 4, 8], dims=[64, 128, 256], embed_dim=768):
        ...
        face_landback_checkpoint = torch.load(r'api\deeplearning\checkpoints\poster_v2\mobilefacenet.pth',
        ...
        ir_checkpoint = torch.load(r'api\deeplearning\checkpoints\poster_v2\ir50.pth', map_location=lambda storage, loc: storage)
